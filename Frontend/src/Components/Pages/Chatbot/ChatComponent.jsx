...
import vector from "/Vector.png"; // Your default image
import arrow from "/arrow.png"; // New image to display with "Need Help?"
  ...
  return (
    <Link to={"/chat-with-ai"} target="_blank">
      <motion.div
        ...
        transition={{ type: "keyframes", stiffness: 300 }} // Smooth transition
        whileTap={{ scale: 0.9 }}
      ...
      >
        ...
        {isHovered && (
          <div className="flex items-center text-3xl">
            <motion.span
              initial={{ opacity: 0, scale: 0.9 }} // Initial state for the hovered text
              animate={{ opacity: 1, scale: 1 }} // Fade in and scale up on hover
              exit={{ opacity: 0, scale: 0.9 }} // Fade out and scale down when not hovered
